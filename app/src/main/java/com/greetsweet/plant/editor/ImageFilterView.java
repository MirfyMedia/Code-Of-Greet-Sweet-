...
import static com.greetsweet.plant.editor.PhotoFilter.NONE;
...
class ImageFilterView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        renderResult();
        if (isSaveImage) {
            final Bitmap mFilterBitmap = com.greetsweet.plant.editor.BitmapUtil.createBitmapFromGLSurface(this, gl);
