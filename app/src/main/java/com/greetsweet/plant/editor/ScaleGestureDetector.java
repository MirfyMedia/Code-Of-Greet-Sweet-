...
class ScaleGestureDetector {
    ...
    interface OnScaleGestureListener {
         ...
         *          greater than 0.01.
         */
        boolean onScale(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector);
         ...
         *          rest of the gesture.
         */
        boolean onScaleBegin(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link com.greetsweet.plant.editor.ScaleGestureDetector#getFocusX()}
         * and {@link com.greetsweet.plant.editor.ScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        void onScaleEnd(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector);
    }
    ...
    static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public boolean onScale(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector) {
            return false;
        }

        public boolean onScaleBegin(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector) {
            return true;
        }

        public void onScaleEnd(View view, com.greetsweet.plant.editor.ScaleGestureDetector detector) {
            // Intentionally empty
        }
    }
