...
import com.greetsweet.plant.editor.BitmapUtil;
...
public class SaveSettings {
    ...
    public static class Builder {
        ...
        public com.greetsweet.plant.editor.SaveSettings build() {
            return new com.greetsweet.plant.editor.SaveSettings(this);
        }
    }
}
