...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel("Name", R.drawable.ic_person_add_black_24dp, ToolType.NAME));
        mToolList.add(new ToolModel("Logo", R.drawable.ic_sticker, ToolType.LOGO));
        mToolList.add(new ToolModel("Website", R.drawable.ic_text, ToolType.WEBSITE));
        mToolList.add(new ToolModel("Upload photo", R.drawable.ic_collections_black_24dp, ToolType.UPLOADPHOTO));
