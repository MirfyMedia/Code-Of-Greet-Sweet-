...
public class GreetingAdapterClass extends RecyclerView.Adapter<GreetingAdapterClass.MyViewHolder> {
    ...
    public GreetingAdapterClass(ArrayList<greetingspojo> data, Context context) {
        this.data = data;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        PhotoApp.getInstance().getstoreSharedpref().storeSharedValue("urlimage",data.get(position).getImage());
