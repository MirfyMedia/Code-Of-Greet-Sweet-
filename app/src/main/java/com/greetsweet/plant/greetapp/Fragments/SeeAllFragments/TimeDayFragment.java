...
String catid, getcategory;

    private MorningAdapterClass adapter;
    ...
    public TimeDayFragment() {
        // Required empty public constructor
    }

    public static TimeDayFragment newInstance(String param1, String param2) {
        TimeDayFragment fragment = new TimeDayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_timeday, container, false);
 catid="1";
 PhotoApp.getInstance().getstoreSharedpref().storeSharedValue("categoryid",catid);
 getcategory= PhotoApp.getInstance().getstoreSharedpref().getSharedValue("categoryid");
        dayrecycler=(RecyclerView)view.findViewById(R.id.dayrecycler);
        dayrecycler.setHasFixedSize(true);

new Task_Cat().execute();
        return  view;
    }

    public class Task_Cat extends AsyncTask<Void, Void, Void> {
...
//
    ...
    private void set_SubcateogryAdapter(int position, ArrayList<subcategories_pojo> val_sub)
    {
        ...
        dayrecycler.setHasFixedSize(true);
        adapter=new MorningAdapterClass(val_sub,getActivity());
